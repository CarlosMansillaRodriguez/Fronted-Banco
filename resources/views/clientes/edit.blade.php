            ...
            <div class="row g-3">
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control" 
                        value="{{ old('nombre', $cliente['usuario']['nombre'] ?? '') }}">
                    @error('nombre')
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" name="apellido" id="apellido" class="form-control" value="{{ old('apellido', $cliente['usuario']['apellido'] ?? '') }}">
                    @error('apellido')
                        <small class="text-danger">{{ '*'.$message }}</small>
                    @enderror
                </div>
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <input type="date" name="fecha_nacimiento" id="fecha_nacimiento" class="form-control" value="{{ old('fecha_nacimiento', $cliente['usuario']['fecha_nacimiento'] ?? '') }}">
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <input type="text" name="genero" id="genero" class="form-control" value="{{ old('genero', $cliente['usuario']['genero'] ?? '') }}">
                    @error('genero')
                        <small class="text-danger">{{ '*'.$message }}</small>
                    @enderror
                </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-4">
                            <input autocomplete="off" type="text" name="nombre_user" id="nombre_user" class="form-control" 
                                   value="{{ old('nombre_user', $cliente['usuario']['nombre_user'] ?? '') }}" aria-labelledby="nameHelpBlock">
                        </div>
                        <div class="col-lg-4">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-4">
                            <input autocomplete="off" type="email" name="email" id="email" class="form-control" 
                                   value="{{ old('email', $cliente['usuario']['email'] ?? '') }}" aria-labelledby="emailHelpBlock">
                        </div>
                        <div class="col-lg-4">
